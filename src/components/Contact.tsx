...
const Contact = () => {
  ...
  return (
    <section
    id="contact"
      className={`${styles.paddingX} relative bg-gradient-to-r from-[#000b1d] to-[#0a1226]  gap-2 py-5`}
    >
      <div className="flex flex-col  justify-center">
        ...
        <div className={`${layout.sectionReverse}`}>
          <div className="flex flex-col gap-5 ">
            ...
            <p className={`${styles.paragraph} max-w-[650px]`}>
            ...
            <div className="flex gap-2 text-dimWhite text-base ">
              ...
              <p className="font-roboto text-[12px]">Maputo / Mocambique </p>
            </div>
          ...
          >
            <div className=" flex flex-col gap-1">
              ...
              <input
                ...
                required
                className=" w-full h-8 px-3 py-2 text-sm placeholder-gray-300 bg-white border-none rounded shadow"
              />
            </div>
            ...
            <div className="">
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="w-full h-8 px-3 py-2 text-sm rounded-md text-gray-200 placeholder-gray-300 bg-white border-none"
              />
            </div>
            ...
            <div className="">
              ...
              <textarea
                ...
                required
                rows={5}
                className="w-full px-3 py-2 text-sm  placeholder-gray-300 bg-white border-none rounded-sm shadow"
              ></textarea>
            </div>

            <button
              disabled={isFetching}
              className=" h-10 hover:scale-110 relative font-serif px-8 py-3 w-full mr-4  rounded-full mt-4 bg-gradient-to-r from-blue-700 via-purple-500 to-red-700 text-dimWhite lg:w-fit"
            >
              Submit now
            </button>
          </form>
