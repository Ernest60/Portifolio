...
const Abaut = () => {
  return (
    <section
      id="abaut"
      className={`${styles.paddingY} flex flex-col  relative backdrop:blur-xl  bg-gradient-to-r from-[#000b1d] to-[#0a1226]`}
    >
      {" "}
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        >
          <h1 className="font-serif  text-dimWhite text-[30px]">Abaut Me</h1>
        </motion.div>
        ...
        <div className={`${layout.sectionReverse}flex mx-10 gap-8 md:gap-0`}>
          ...
          <div className="min-w-[550px] flex flex-col gap-8">
            <div className={`${styles.marginX} text-dimWhite`}>
              <p className="mb-1 ">
            ...
            <div className={`${styles.marginX} flex flex-col gap-2`}>
              <motion.div
                whileHover={{ scale: 1.05 }}
                transition={{ duration: 0.2 }}
                className="relative flex gap-6 items-center transition:0.3s text-dimWhite"
              >
                <p className={`${styles.paragraph} min-w-[120px]`}>
                  HTML & CSS{" "}
                </p>{" "}
                <hr
              ...
              <motion.div
                ...
                className="relative flex gap-6 items-center transition:0.3s text-dimWhite"
              >
                <p className={`${styles.paragraph} min-w-[120px]`}>React Js </p>{" "}
                <hr
                  className="outline-none border-none w-[50%] h-2  rounded-lg bg-gradient-to-r from-purple-500 to-red-500 "
                  style={{ width: "70%" }}
                />
              ...
              <motion.div
                ...
                className="relative flex gap-6 items-center transition:0.3s text-dimWhite"
              >
                <p className={`${styles.paragraph} min-w-[120px]`}>Next Js </p>{" "}
                <hr
                  className="outline-none border-none w-[50%] h-2  rounded-lg bg-gradient-to-r from-purple-500 to-red-500"
                  style={{ width: "60%" }}
                />
